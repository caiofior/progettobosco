<div id="content_schedab3_alberature">
    ...
    $cod_coper_coll = $b3treelinecomposition->getControl('cod_coper');
    $b3treelinecompositioncoll = $b3->getRenovationCompositionColl();
    ...
    $b3treelinecompositioncoll->loadAll(array(
        'start'=>$_GET['start'],
        'length'=>$items_in_page
    ));
    foreach ($b3treelinecompositioncoll->getItems() as $b3treelinecomposition) :
    ?>
    <div>
        <span>
            <div>
    ...
    $countall =$b3treelinecompositioncoll->countAll();
