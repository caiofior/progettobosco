<div id="content_schedab2_arbustive">
    ...
    <div>
        ...
        <span>
            <div>
                <a href="<?php echo $GLOBALS['BASE_URL'];?>bosco.php?task=formb2&id=<?php echo $b2->getData('objectid');?>&deletearbustive=<?php echo $shrubcomposition->getData('objectid');?>"  >
    ...
    if ($start>0) {
        $actions['prev']=array(
            ...
            'data-update'=>'data-update="content_schedab2_arbustive"'
        );
        $actions['first']=array(
