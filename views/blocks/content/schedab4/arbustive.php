<div id="content_schedab4_arbustive">
    <?php
    if (!isset($b4)) {
    ...
    <div>
        ...
        <span>
            <div>
                <a href="<?php echo $GLOBALS['BASE_URL'];?>bosco.php?task=formb3&amp;id=<?php echo $b4->getData('objectid');?>&amp;deletearbustive=<?php echo $shrubcomposition->getData('objectid');?>"  >
    ...
    if ($start>0) {
        $actions['prev']=array(
            ...
            'data-update'=>'data-update="content_schedab4_arbustive"'
        );
        $actions['first']=array(
