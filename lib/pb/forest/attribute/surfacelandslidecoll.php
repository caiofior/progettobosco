 ...
 * @copyright CRA
 * Manages Surface Landslide collection
 */
 ...
 * Manages Surface Landslide collection
 */
class SurfaceLandslideColl  extends \ContentColl implements template\AttributeColl {
    /**
     * Forest Reference
     * @var \forest\Forest 
     */
    ...
    public function __construct() {
        parent::__construct(new SurfaceLandslide());
    }
    /**
