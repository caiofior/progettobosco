 ...
 * @copyright CRA
 * Manages Other Root Limiting Factor collection
 */
 ...
 * Manages Other Root Limiting Factor collection
 */
class OtherRootLimitingFactorColl  extends \ContentColl implements template\AttributeColl {
    /**
     * Forest Reference
     * @var \forest\Forest 
     */
    ...
    public function __construct() {
        parent::__construct(new OtherRootLimitingFactor ());
    }
    /**
