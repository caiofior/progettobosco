<?php
/**
 * Manages Entity F forest compartment
 * 
 * Manages Entity F forest compartment
 * 
 ...
 * @copyright CRA
 */
class F extends \forest\template\Entity {
     /**
     * Instantiates the table
     */
    public function __construct() {
        parent::__construct('schede_f');
    }
    /**
     * Loads form a data
     * @param integer $id
    ...
    /**
     * Gets the associated F1 Collection
     * @return \forest\entity\x\F1Coll
     */
    public function getF1Coll () {
        $f1coll = new \forest\entity\x\F1Coll();
        $f1coll->setFormF($this);
        return $f1coll;
    }
     /**
     * Gets the associated F2 Collection
     * @return \forest\entity\x\F2Coll
     */
    public function getF2Coll () {
        $f2coll = new \forest\entity\x\F2Coll();
        $f2coll->setFormF($this);
        return $f2coll;
    }
