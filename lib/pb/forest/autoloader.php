...
if (!class_exists('Forest')) {
    ...
    $files = array(
        ...
        'attribute'.DIRECTORY_SEPARATOR.'corkshrubcomposition.php',
        'attribute'.DIRECTORY_SEPARATOR.'corkshrubcompositioncoll.php',
        'attribute'.DIRECTORY_SEPARATOR.'corkherbaceuscomposition.php',
        'attribute'.DIRECTORY_SEPARATOR.'corkherbaceuscompositioncoll.php',
