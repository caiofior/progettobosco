...
if (!class_exists('Forest')) {
    ...
    $files = array(
        ...
        'form'.DIRECTORY_SEPARATOR.'b4.php',
        'form'.DIRECTORY_SEPARATOR.'b4coll.php',
        ...
        'attribute'.DIRECTORY_SEPARATOR.'noteb4.php',
        'attribute'.DIRECTORY_SEPARATOR.'noteb4coll.php',
        ...
        'attribute'.DIRECTORY_SEPARATOR.'b4shrubcomposition.php',
        'attribute'.DIRECTORY_SEPARATOR.'b4shrubcompositioncoll.php',
        'attribute'.DIRECTORY_SEPARATOR.'b4covercomposition.php',
        'attribute'.DIRECTORY_SEPARATOR.'b4covercompositioncoll.php',
        'attribute'.DIRECTORY_SEPARATOR.'b4herbaceuscomposition.php',
        'attribute'.DIRECTORY_SEPARATOR.'b4herbaceuscompositioncoll.php',
