<?php
require ("files/common.php");
apri_html("Schede A Schede B1 Schede B2 Schede B3 Scheda B4");
?>
...
<body bgcolor=teal text=white vlink=#0040cc link=#0080ff>
  ...
  <table width=100% height=100%>
	...
	if (!isset($_GET['scheda']))
	  ...
	  $_GET['scheda'] = "undefine";
 	  }
	if (!isset($_GET['codice1']))
	  {//If not isset -> set with dumy value
	  $_GET['codice1'] = "undefine";
	  }
	if (!isset($_GET['cod_part1']))
	  {//If not isset -> set with dumy value
	  $_GET['cod_part1'] = "undefine";
	  }

	$scheda=$_GET["scheda"];
	  echo $scheda . " <br>";
	  $codice=$_GET['codice1'];
	    echo $codice . " mizzeca <br>";
	  $cod_part=($_GET['cod_part1']);
	    echo $cod_part . " mizzeca cod_part <br>";
//------------------------------------------------------------ Scheda A -------------------------------------------------
		if($scheda == "Schede A"){
	?>
	  <table width=100% height=75% border=1>
	    <tr>
	      <th colspan=19>
		<font size=+3>
		  Schede A per descrivere i fattori ambientali e di gestione
		</font>
	      </th>
	    </tr>
	  <?php 
...
// 	    echo $codice . "=codice1 ";
// 	  $cod_part=($_GET['cod_part1']);
// 	    echo $cod_part . "=cod_part1 ";
	  $conn=connessione_db();

	  $rubrica=pg_Exec($conn,"select 
	      propriet.descrizion,RiLEVATO.descriz AS rilevato_descriz,SCHEDE_A.datasch,SCHEDE_A.sup_tot, 
	      SCHEDE_A.cod_part,comuni.descriz as comuni_descriz,SCHEDE_A.toponimo,SCHEDE_A.ap,SCHEDE_A.pp,
	      SCHEDE_A.delimitata,posfisio.descriz AS posfisio_descriz,espo.descriz AS espo_descriz,SCHEDE_A.a2,SCHEDE_A.a3,
	      SCHEDE_A.a4,SCHEDE_A.a6,SCHEDE_A.a7,SCHEDE_A.a8,SCHEDE_A.r2,
	      SCHEDE_A.r3,SCHEDE_A.r4,SCHEDE_A.r5,SCHEDE_A.r6,
	      SCHEDE_A.r7,SCHEDE_A.f2,SCHEDE_A.f3,SCHEDE_A.f4,
	      SCHEDE_A.f5,SCHEDE_A.f6,SCHEDE_A.f7,SCHEDE_A.f8,
	      SCHEDE_A.f10,SCHEDE_A.f11,SCHEDE_A.f12,SCHEDE_A.v3,
	      SCHEDE_A.v1,ostacoli.descriz AS ostacoli_descriz,SCHEDE_A.c1,SCHEDE_A.c2,
	      SCHEDE_A.c3,SCHEDE_A.c4,SCHEDE_A.c5,SCHEDE_A.c6,
	      SCHEDE_A.p1,SCHEDE_A.p2,specie_p.descriz AS specie_p_descriz,SCHEDE_A.p9,
	      SCHEDE_A.p3,SCHEDE_A.p4,SCHEDE_A.p5,SCHEDE_A.p6,
	      SCHEDE_A.p8,SCHEDE_A.i1,SCHEDE_A.i2,SCHEDE_A.i3,
	      SCHEDE_A.i4,SCHEDE_A.i5,SCHEDE_A.i6,SCHEDE_A.i7,
	      SCHEDE_A.i8,SCHEDE_A.i21,SCHEDE_A.i22,SCHEDE_A.m1,
	      SCHEDE_A.m2,SCHEDE_A.m3,SCHEDE_A.m4,SCHEDE_A.m20,
	      SCHEDE_A.m5,SCHEDE_A.m6,SCHEDE_A.m7,SCHEDE_A.m8,
	      SCHEDE_A.m9,SCHEDE_A.m10,SCHEDE_A.m12,SCHEDE_A.m13,
	      SCHEDE_A.m15,SCHEDE_A.m14,SCHEDE_A.m16,SCHEDE_A.m17,
	      SCHEDE_A.m18,SCHEDE_A.m19
		FROm (
		  (
		    (
		      (
			(
			  (SCHEDE_A LEFT JOiN RiLEVATO ON RiLEVATO.codice = SCHEDE_A.codiope) 
			LEFT JOiN comuni ON comuni.codice = SCHEDE_A.comune)
		      LEFT JOiN posfisio ON posfisio.codice=SCHEDE_A.pf1)
		    LEFT JOiN espo ON espo.codice = SCHEDE_A.e1)
		  LEFT JOiN ostacoli ON ostacoli.codice = SCHEDE_A.o) 
		LEFT JOiN specie_p ON specie_p.codice = SCHEDE_A.p7)
		iNNER JOiN propriet ON SCHEDE_A.proprieta = propriet.codice 
	      WHERE (SCHEDE_A.proprieta='$codice' AND SCHEDE_A.cod_part='$cod_part');");
...
<tr>
<td colspan=2><font size=-1><?echo $elenco->i21 ?></font></td>
<td colspan=2><font size=-1><?echo $elenco->i22 ?></font></td></tr>
<tr></tr>    
...
<?php
$rubrica=pg_Exec($conn,"select catasto.foglio,catasto.particella,catasto.sup_tot,catasto.sup_bosc,catasto.porz_perc,catasto.note from catasto WHERE proprieta='$codice' AND cod_part='$cod_part';");
$riga = 0;
while ($elenco = @pg_fetch_object ($rubrica ,$riga)) {
...
<div align=center>
<a href="descrp.php">
<img src='files/esci.bmp' border='0' width='38' height='39'></img></a> indietro
</div>-->
</td></tr></table>
</body>
<?php
pag_precedente("descrp.php"); //richiamo funzione che sta in files/common.php
//
